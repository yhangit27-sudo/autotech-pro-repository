        ...
        <form method="POST" action="<?php echo e(route('services.store')); ?>">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="description" class="form-control" 
                       value="<?php echo e(old('description')); ?>" placeholder="Ex: Alinhamento e Balanceamento" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="hourly_rate" class="form-control" 
                           value="<?php echo e(old('hourly_rate')); ?>" step="0.01" min="0" required placeholder="0,00">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\icro\autotech-pro-repository\autotech-pro\resources\views/services-catalog/create.blade.php ENDPATH**/ ?>