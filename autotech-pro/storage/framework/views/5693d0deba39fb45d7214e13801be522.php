...
<?php $__env->startSection('title', 'Editar OS'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="d-flex align-items-center gap-2 mb-0 text-white">
        ...
        Editar Diagnóstico <span class="text-danger">OS #<?php echo e($order->id); ?></span>
    </h2>
    <a href="<?php echo e(route('orders.show', $order->id)); ?>" class="btn btn-outline-light btn-sm d-flex align-items-center gap-2">
        ...
        <form method="POST" action="<?php echo e(route('orders.update', $order->id)); ?>">
            ...
            <div class="mb-4">
                ...
                <select class="form-select" name="mechanic_id">
                    ...
                    <option value="<?php echo e($m->id); ?>" <?php echo e($order->mechanic_id == $m->id ? 'selected' : ''); ?>>
            ...
            <div class="mb-5">
                ...
                <textarea class="form-control" name="mechanic_diagnosis" rows="8" 
                          placeholder="Descreva detalhadamente as falhas encontradas, peças que precisam de troca e o serviço a ser executado..."><?php echo e(old('mechanic_diagnosis', $order->mechanic_diagnosis)); ?></textarea>
            ...
            <div class="d-flex flex-column flex-sm-row gap-3">
                ...
                <a href="<?php echo e(route('orders.show', $order->id)); ?>" class="btn btn-outline-secondary d-flex align-items-center justify-content-center">
                    Cancelar
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\icro\autotech-pro-repository\autotech-pro\resources\views/service-orders/edit.blade.php ENDPATH**/ ?>