...
<div class="d-flex justify-content-between align-items-center mb-4 text-white">
    ...
    <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-light btn-sm">← Voltar</a>
</div>
        ...
        <form method="POST" action="<?php echo e(route('users.store')); ?>">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="full_name" class="form-control" value="<?php echo e(old('full_name')); ?>" placeholder="Nome do colaborador ou cliente" required>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="exemplo@email.com" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="tax_id" class="form-control" value="<?php echo e(old('tax_id')); ?>" placeholder="000.000.000-00" maxlength="18" required>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="role" required>
                        ...
                        <option value="attendant" <?php echo e(old('role') == 'attendant' ? 'selected' : ''); ?>>Atendente</option>
                        <option value="mechanic"  <?php echo e(old('role') == 'mechanic'  ? 'selected' : ''); ?>>Mecânico</option>
            ...
            <div class="d-grid gap-2">
                ...
                <a href="<?php echo e(route('users.index')); ?>" class="btn btn-link text-muted text-decoration-none small">Cancelar</a>
            </div>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\icro\autotech-pro-repository\autotech-pro\resources\views/users/create.blade.php ENDPATH**/ ?>