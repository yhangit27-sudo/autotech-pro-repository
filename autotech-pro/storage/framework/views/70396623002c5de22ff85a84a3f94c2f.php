...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo e(route('vehicles.create')); ?>" class="btn btn-marca d-inline-flex align-items-center gap-2 px-3 shadow-sm">
    ...
    <div class="card-body p-0 table-responsive">
        <table class="table table-dark table-hover mb-0 align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4">
                        <div class="placa-preta"><?php echo e($v->license_plate); ?></div>
                    </td>
                    <td>
                        <div class="text-white fw-bold"><?php echo e($v->brand); ?></div>
                        <div class="text-muted small"><?php echo e($v->model); ?></div>
                    </td>
                    <td class="text-muted small font-monospace"><?php echo e($v->fipe_code ?? '---'); ?></td>
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            <i data-lucide="user" class="size-3 text-muted"></i>
                            <span class="small"><?php echo e($v->customer_name); ?></span>
                        </div>
                    </td>
                    <td class="pe-4 text-end">
                        <div class="btn-group">
                            <a href="<?php echo e(route('vehicles.show', $v->id)); ?>" class="btn btn-sm btn-outline-light border-0" title="Ver Histórico">
                                <i data-lucide="history" class="size-4"></i>
                            </a>
                            <?php if(in_array(session('user_role'), ['manager', 'attendant'])): ?>
                            <a href="<?php echo e(route('vehicles.edit', $v->id)); ?>" class="btn btn-sm btn-outline-light border-0" title="Editar">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\icro\autotech-pro-repository\autotech-pro\resources\views/vehicles/index.blade.php ENDPATH**/ ?>