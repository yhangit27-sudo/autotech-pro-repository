...
<?php $__env->startSection('title', 'Editar Peça'); ?>
...
<div class="card edit-card shadow-lg mx-auto" style="max-width: 650px;">
    <div class="card-body p-4 p-md-5">
        <form method="POST" action="<?php echo e(route('parts.update', $part->id)); ?>">
            <?php echo csrf_field(); ?>
            

            <div class="mb-4">
                <label class="label-small mb-2 d-block">Nome da Peça</label>
                <input type="text" name="name" class="form-control" value="<?php echo e(old('name', $part->name)); ?>" required>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="cost_price" class="form-control" value="<?php echo e(old('cost_price', $part->cost_price)); ?>" step="0.01" min="0" required>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">R$</span>
                        <input type="number" name="sale_price" class="form-control" value="<?php echo e(old('sale_price', $part->sale_price)); ?>" step="0.01" min="0" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="label-small mb-2 d-block">Qtd. em Estoque</label>
                    <input type="number" name="stock_quantity" class="form-control" value="<?php echo e(old('stock_quantity', $part->stock_quantity)); ?>" min="0" required>
                </div>
                <div class="col-md-6">
                    <label class="label-small mb-2 d-block">Garantia (Meses)</label>
                    <input type="number" name="manufacturer_warranty_months" class="form-control" value="<?php echo e(old('manufacturer_warranty_months', $part->manufacturer_warranty_months)); ?>" min="0">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\icro\autotech-pro-repository\autotech-pro\resources\views/parts/edit.blade.php ENDPATH**/ ?>