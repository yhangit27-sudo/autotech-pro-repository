    ...
    <div class="card-body p-4 p-md-5">
        <form method="POST" action="{{ route('parts.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Ex: Pastilha de freio dianteira" required>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="cost_price" class="form-control" value="{{ old('cost_price') }}" step="0.01" min="0" required placeholder="0,00">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">R$</span>
                        <input type="number" name="sale_price" class="form-control" value="{{ old('sale_price') }}" step="0.01" min="0" required placeholder="0,00">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="label-small mb-2 d-block">Qtd. Inicial *</label>
                    <input type="number" name="stock_quantity" class="form-control" value="{{ old('stock_quantity') }}" min="0" required placeholder="0">
                </div>
                <div class="col-md-6">
                    <label class="label-small mb-2 d-block">Garantia (Meses)</label>
                    <input type="number" name="manufacturer_warranty_months" class="form-control" value="{{ old('manufacturer_warranty_months', 3) }}" min="0">
                </div>
            </div>
